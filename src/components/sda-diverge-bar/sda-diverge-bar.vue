...
<script>
// var json = '../static/bar.json';
// import BaseChartMixin from '../../mixins/sda-chart-mixin';
...
export default {
  ...
  mounted () {
    /* eslint-disable */
    var margin = {top: 80, right: 50, bottom: 20, left: 60};
    ...
    d3.csv("./static/diverge-bar-data.csv", function(error, data) {
